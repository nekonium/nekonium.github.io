...
NekoniumはNekonium Projectが開発しています。これは一般的な非中央集権型の投機通貨ではなく、採掘や投資で経済的な利益を得ることは難しいことに注意してください。また、Nekonium projectはNekoniumを法定通貨へ換金する手段を提供しません。投機目的での入手、第三者からの購入はしないでください。
