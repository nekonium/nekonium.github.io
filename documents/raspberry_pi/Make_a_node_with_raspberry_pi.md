...
![download_diskimager](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/download_diskimager.jpg)
</div></details>
...
![diskimager](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/diskimager.jpg)
</div></details>
...
![view_ext](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/view_ext.jpg)

Explorerの右ペインの空いてる部分で（ほかのファイルを選択しないように）右クリックして新規作成、テキストドキュメントと選択していきます。
![create_txt](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/create_txt.jpg)
...
![save_ssh_file](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/save_ssh_file.jpg)
...
![wifiguard_check](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/wifiguard_check.jpg)
</div></details>
...
![wifiguard_search_ip](https://github.com/nekonium/nekonium.github.io/blob/master/documents/raspberry_pi/image/wifiguard_search_ip.jpg)
</div></details>
...
例えば192.168.1.105/25の場合は、第4オクテットに入る数字が1-126までになります。

つまり2進数でこの値を表現した場合に、第1オクテットの最上位ビットから25ビット分がネットワークアドレスとして用いられ、残りの7ビットがホストアドレスとして用いられることになります。
